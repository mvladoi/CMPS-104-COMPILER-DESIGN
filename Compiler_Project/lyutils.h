...
extern FILE* tok_output;
extern FILE* ast_output;
extern FILE* oil_output;
extern FILE* sym_output;
extern astree_queue string_queue;
extern astree_queue prototype_queue;
extern astree_queue struct_queue;
extern astree_queue globalv_queue;
extern astree_queue function_queue;
...
extern FILE* yyin;
//extern FILE* tok_ouput;
extern string anothername; 
extern char* yytext; 
...
void tok_dump(astree* t, FILE* fp);
